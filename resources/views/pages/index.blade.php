                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="row mt-3">
                                            ...
                                            <div class="col-6 my-2 w-100">
                                                <input type="date" class="form-control bg-light w-100"
                                                    placeholder="2017-06-04" id="mdate">

                                            </div>
                                            <div class="col-6 my-2 w-100">
                                                <input type="time" class="form-control bg-light w-100"
                                                    placeholder="2017-06-04" id="mdate">
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div>
                                            <div class="d-flex align-items-center px-1 border border-dark rounded">
                                                <span><svg xmlns="http://www.w3.org/2000/svg" width="15"
                                            ...
                                            <ul class="list-group">
                                                ...
                                                <li class="list-group-item pb-2">
                                                    <p class="small_text mb-0">Ministry of Healt</p>
                                                    <div class="d-flex justify-content-between">
                                                        <p class="mb-0"><b>₦730,000.00</b></p>
                                                        <small><a href="">add item</a></small>
                                                    </div>
                                            ...
                                            <div class="col-md-9">
                                                <div class="row">
                                                    ...
                                                    <div class=" pt-3 col-5">
                                                        <select class="form-control rounded-0 btn-sm" id="sel1">
